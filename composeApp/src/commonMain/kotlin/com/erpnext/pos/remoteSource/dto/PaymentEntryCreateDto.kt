...
data class PaymentEntryCreateDto(
    ...
    @SerialName("party") val partyId: String,
    ...
    @SerialName("paid_from") val paidFrom: String? = null,
    @SerialName("paid_to") val paidTo: String? = null,
    @SerialName("paid_to_account_currency") val paidToAccountCurrency: String? = null,
    @SerialName("source_exchange_rate") val sourceExchangeRate: Double? = null,
    @SerialName("target_exchange_rate") val targetExchangeRate: Double? = null,
    @SerialName("reference_no") val referenceNo: String? = null,
    @SerialName("reference_date") val referenceDate: String? = null,
    @SerialName("references") val references: List<PaymentEntryReferenceCreateDto> = emptyList(),
    @SerialName("docstatus") @EncodeDefault(EncodeDefault.Mode.NEVER) val docStatus: Int? = null,
)

@Serializable
data class PaymentEntryReferenceCreateDto(
    @SerialName("reference_doctype") val referenceDoctype: String,
