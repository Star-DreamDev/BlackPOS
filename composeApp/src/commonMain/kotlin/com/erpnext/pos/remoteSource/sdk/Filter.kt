...
/**
 * Filter tipado: evita Any en la API pública. value puede ser String/Number/Boolean o
...
private fun toJsonElement(value: Any): JsonElement =
    when (value) {
      ...
      is List<*> ->
              ...
              when (v) {
                ...
                null -> add(JsonNull)
                    ...
                    throw IllegalArgumentException(
                        "Tipo no soportado en lista de filtro: ${v::class.simpleName}"
                    )
              }
            }
          }
          ...
          throw IllegalArgumentException("Tipo de filtro no soportado: ${value::class.simpleName}")
    }
