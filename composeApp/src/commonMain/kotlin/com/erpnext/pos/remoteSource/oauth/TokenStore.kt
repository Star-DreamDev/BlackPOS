...
interface AuthInfoStore {
  ...
  suspend fun updateSiteMeta(url: String, lastUsedAt: Long? = null, isFavorite: Boolean? = null)

  suspend fun clearAuthInfo()
}

/**
 * Guardar pkce.verifier y state como transitorio y eliminarlos inmediatamente despues de completar
 * el intercambio de `code` por `token`. Cumplimiento de seguridad
 */
