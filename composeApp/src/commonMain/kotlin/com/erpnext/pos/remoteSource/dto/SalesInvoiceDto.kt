...
data class SalesInvoiceDto(
    ...
    @SerialName("contact_mobile") val customerPhone: String? = null,
    val company: String,
    ...
    @SerialName("total_taxes_and_charges") val totalTaxesAndCharges: Double? = 0.0,
    @SerialName("total") val total: Double? = null,
    @SerialName("net_total") val netTotal: Double,
    @SerialName("rounded_total") val roundedTotal: Double? = null,
    @SerialName("rounding_adjustment") val roundingAdjustment: Double? = null,
    @EncodeDefault(EncodeDefault.Mode.NEVER)
    ...
    @SerialName("apply_discount_on") val applyDiscountOn: String? = null,
    @SerialName("additional_discount_percentage") val additionalDiscountPercentage: Double? = null,
    ...
    @SerialName("write_off_amount") val writeOffAmount: Double? = null,
    val items: List<SalesInvoiceItemDto> = emptyList(),
    @SerialName("payments") val payments: List<SalesInvoicePaymentDto> = emptyList(),
    ...
    @SerialName("is_pos") @Serializable(IntAsBooleanSerializer::class) val isPos: Boolean = false,
    @EncodeDefault(EncodeDefault.Mode.NEVER)
    @SerialName("is_created_using_pos")
    @Serializable(IntAsBooleanSerializer::class)
    val isCreatedUsingPos: Boolean? = null,
    @SerialName("update_stock")
    @Serializable(with = IntAsBooleanSerializer::class)
    val updateStock: Boolean = false,
    val doctype: String = "Sales Invoice",
    @SerialName("pos_profile") val posProfile: String? = null,
    @SerialName("currency") val currency: String? = null,
    @SerialName("conversion_rate") val conversionRate: Double? = null,
    @SerialName("party_account_currency") val partyAccountCurrency: String? = null,
    @SerialName("return_against") val returnAgainst: String? = null,
    @SerialName("pos_opening_entry") val posOpeningEntry: String? = null,
    @EncodeDefault(EncodeDefault.Mode.NEVER) @SerialName("debit_to") val debitTo: String? = null,
    @EncodeDefault(EncodeDefault.Mode.NEVER) @SerialName("docstatus") val docStatus: Int? = null,
    @SerialName("is_return") val isReturn: Int = 0,

    // Response
    @SerialName("base_grand_total") val baseGrandTotal: Double? = null,
    @SerialName("base_total") val baseTotal: Double? = null,
    @SerialName("base_net_total") val baseNetTotal: Double? = null,
    @SerialName("base_total_taxes_and_charges") val baseTotalTaxesAndCharges: Double? = null,
    @SerialName("base_rounding_adjustment") val baseRoundingAdjustment: Double? = null,
    @SerialName("base_rounded_total") val baseRoundedTotal: Double? = null,
    @SerialName("base_discount_amount") val baseDiscountAmount: Double? = null,
    @SerialName("base_paid_amount") val basePaidAmount: Double? = null,
    @SerialName("base_change_amount") val baseChangeAmount: Double? = null,
    @SerialName("base_write_off_amount") val baseWriteOffAmount: Double? = null,
)

@Serializable
data class SalesInvoicePaymentScheduleDto(
    @SerialName("payment_term") val paymentTerm: String? = null,
...
data class SalesInvoiceItemDto(
    ...
    @SerialName("so_detail") val salesOrderItem: String? = null,
    @SerialName("delivery_note") val deliveryNote: String? = null,
    @SerialName("dn_detail") val deliveryNoteItem: String? = null,
