...
data class PaymentEntryDto(
    ...
    @SerialName("unallocated_amount") val unallocatedAmount: Double? = null,
    @SerialName("paid_from_account_currency") val paidFromAccountCurrency: String? = null,
    @SerialName("paid_to_account_currency") val paidToAccountCurrency: String? = null,
    @SerialName("docstatus") val docstatus: Int? = null,
    @SerialName("modified") val modified: String? = null,
    @SerialName("territory") val territory: String? = null,
    @SerialName("references") val references: List<PaymentEntryReferenceDto> = emptyList(),
)

@Serializable
data class PaymentEntryReferenceDto(
    @SerialName("payment_entry") val paymentEntry: String? = null,
    @SerialName("pos_opening_entry") val posOpeningEntry: String? = null,
    @SerialName("reference_doctype") val referenceDoctype: String? = null,
