...
data class SupplierDto(
    ...
    @SerialName("supplier_group") val supplierGroup: String? = null,
    @SerialName("supplier_type") val supplierType: String? = null,
    @SerialName("default_currency") val defaultCurrency: String? = null,
    @SerialName("payment_terms") val paymentTerms: String? = null,
    @SerialName("disabled") val disabled: Int? = null,
)
...
data class CompanyAccountDto(
    ...
    @SerialName("is_group") val isGroup: Int? = null,
