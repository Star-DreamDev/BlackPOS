...
private fun SystemSummaryCardMultiCurrency(
  ...
  val expensesBreakdown =
      buildCurrencySummaryLine(
          expensesByCurrency.ifEmpty {
            mapOf(summary.currency.uppercase() to summary.expensesTotal)
          },
          formatAmountFor,
      )
  Card(
...
private fun ReconciliationActionsBar(
  ...
  Card(
    ...
    Column {
      Box(
          modifier =
              Modifier.fillMaxWidth().height(4.dp).background(MaterialTheme.colorScheme.primary)
      )
      Row(
          modifier = Modifier.padding(16.dp),
          horizontalArrangement = Arrangement.SpaceBetween,
        ...
        Row(
          ...
          Button(
              ...
              colors =
                  ButtonDefaults.buttonColors(
                      containerColor =
                          if (hasDifference) MaterialTheme.colorScheme.error
