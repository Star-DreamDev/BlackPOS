...
/**
 * Utilidades puras de Billing (totales / descuentos). Mantener aquí para evitar acoplar
 * PaymentUtils a BillingState.
 */
...
fun resolveDiscountInfo(
  ...
  val discountBase =
      if (state.applyDiscountOn.equals("Grand Total", ignoreCase = true)) {
        subtotal + taxes
      } else {
        subtotal
      }
