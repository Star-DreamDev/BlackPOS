...
suspend fun buildPaymentReconciliationSeeds(
  ...
  val openingByMode =
      balanceDetails.associate { it.modeOfPayment to roundToCurrency(it.openingAmount) }
  val closingByMode =
      balanceDetails.associate { detail ->
...
private fun resolvePaymentCurrency(row: ShiftPaymentRow, posCurrency: String): String {
