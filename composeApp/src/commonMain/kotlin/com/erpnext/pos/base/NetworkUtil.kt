...
inline fun <ResultType, RequestType> networkBoundResource(
    ...
    crossinline shouldFetch: suspend (ResultType) -> Boolean = {
      true
    }, // 🔹 Condición opcional de refresco
  ...
  val localUpdatedAtMillis =
      if (localData != null && fetchTtlMillis != null && resolveLocalUpdatedAtMillis != null) {
  ...
  val flow =
      if (localData != null && !shouldFetchNow) {
...
/**
 * Extensión avanzada para refrescar manualmente los datos. Ideal para ViewModels que necesiten
 * `refresh` desde UI.
 */
