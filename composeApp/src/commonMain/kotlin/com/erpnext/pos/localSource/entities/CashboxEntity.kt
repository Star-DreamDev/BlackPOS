...
@Entity(
    ...
    indices =
        [Index(value = ["posProfile", "user", "openingEntryId", "closingEntryId"], unique = true)],
)
...
data class BalanceDetailsEntity(
    ...
    @ColumnInfo(name = "cashbox_id") var cashboxId: Long,
    @ColumnInfo(name = "pos_opening_entry") var posOpeningEntry: String? = null,
    @ColumnInfo(name = "pos_closing_entry") var posClosingEntry: String? = null,
    @ColumnInfo(name = "mode_of_payment") var modeOfPayment: String,
    @ColumnInfo(name = "opening_amount") var openingAmount: Double,
    @ColumnInfo(name = "closing_amount") var closingAmount: Double? = null,
)

data class CashboxWithDetails(
    @Embedded var cashbox: CashboxEntity,
    @Relation(parentColumn = "localId", entityColumn = "cashbox_id")
