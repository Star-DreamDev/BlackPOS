...
interface ContactDao {
  ...
  @Query("UPDATE tabContact SET is_deleted = 1 WHERE is_deleted = 0") suspend fun softDeleteAll()

  @Query("DELETE FROM tabContact WHERE is_deleted = 1") suspend fun hardDeleteAllDeleted()
