...
interface TerritoryDao {
  ...
  @Query("DELETE FROM tabTerritory WHERE is_deleted = 1") suspend fun hardDeleteAllDeleted()

  @Query("UPDATE tabTerritory SET is_deleted = 1 WHERE is_deleted = 0") suspend fun softDeleteAll()
