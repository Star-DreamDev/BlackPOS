...
data class CompanyAccountEntity(
    ...
    @ColumnInfo(name = "account_type") var accountType: String? = null,
    @ColumnInfo(name = "account_currency") var accountCurrency: String? = null,
    @ColumnInfo(name = "company") var company: String? = null,
    @ColumnInfo(name = "is_group") var isGroup: Int? = null,
