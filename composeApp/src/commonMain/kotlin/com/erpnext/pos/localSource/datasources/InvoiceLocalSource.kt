...
class InvoiceLocalSource(private val salesInvoiceDao: SalesInvoiceDao) : IInvoiceLocalSource {
  override fun getPendingInvoices(
      today: String
  ): PagingSource<Int, SalesInvoiceWithItemsAndPayments> = salesInvoiceDao.getOverdueInvoices(today)
  ...
  suspend fun findRecentDebitTo(
    ...
    return salesInvoiceDao
        ...
        ?: salesInvoiceDao
            ...
            ?.takeIf { it.isNotBlank() }
        ?: salesInvoiceDao
            .findLatestDebitTo(company = company, customer = null, partyAccountCurrency = null)
            ?.takeIf { it.isNotBlank() }
  }
  ...
  override suspend fun saveInvoiceLocally(
    ...
    salesInvoiceDao.insertFullInvoice(invoice, items, payments)
  }
  ...
  override suspend fun softDeleteMissingForProfile(profileId: String, invoiceNames: List<String>) {
  ...
  override suspend fun getInvoiceNamesMissingItems(profileId: String, limit: Int): List<String> {
