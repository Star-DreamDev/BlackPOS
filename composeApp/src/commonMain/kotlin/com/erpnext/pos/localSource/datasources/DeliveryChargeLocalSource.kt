...
class DeliveryChargeLocalSource(private val dao: DeliveryChargeDao) : IDeliveryChargeLocalSource {
  ...
  override suspend fun hardDeleteDeletedMissing(labels: List<String>) =
      dao.hardDeleteDeletedNotIn(labels)
