...
data class POSClosingEntryEntity(
    ...
    @ColumnInfo(name = "pos_opening_entry") var posOpeningEntry: String,
    var user: String,
    @ColumnInfo(name = "period_start_date") var periodStartDate: String,
    @ColumnInfo(name = "period_end_date") var periodEndDate: String,
    @ColumnInfo(name = "closing_amount") var closingAmount: Double,
...
data class POSClosingWithTaxes(
    ...
    @Relation(parentColumn = "name", entityColumn = "pos_closing_entry")
