...
interface AddressDao {
  ...
  @Query("UPDATE tabAddress SET is_deleted = 1 WHERE is_deleted = 0") suspend fun softDeleteAll()

  @Query("DELETE FROM tabAddress WHERE is_deleted = 1") suspend fun hardDeleteAllDeleted()
