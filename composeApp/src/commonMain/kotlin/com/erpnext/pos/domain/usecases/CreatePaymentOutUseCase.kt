...
data class CreatePaymentOutInput(val clientRequestId: String, val payload: PaymentOutCreateDto)

class CreatePaymentOutUseCase(private val repository: PaymentOutRepository) :
