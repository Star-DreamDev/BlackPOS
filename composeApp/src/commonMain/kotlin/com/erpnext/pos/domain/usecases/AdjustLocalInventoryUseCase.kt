...
data class StockDelta(val itemCode: String, val qty: Double)

data class AdjustLocalInventoryInput(val warehouse: String, val deltas: List<StockDelta>)

class AdjustLocalInventoryUseCase(private val repo: InventoryRepository) :
