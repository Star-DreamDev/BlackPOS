...
/**
 * Local-only customer lookup used by the Customer view. Data sources:
 * - CustomerLocalSource (customers cached locally)
 */
class FetchCustomersLocalWithStateUseCase(private val localSource: CustomerLocalSource) :
