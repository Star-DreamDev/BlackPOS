...
class LoadInventoryAlertsUseCase(private val repository: InventoryAlertRepository) :
  ...
  override suspend fun useCaseFunction(input: InventoryAlertInput): List<InventoryAlert> {
    return repository.loadAlerts(warehouseId = input.warehouseId, limit = input.limit)
  }
}
