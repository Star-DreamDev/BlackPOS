...
data class CreateSalesInvoiceLocalInput(val localInvoiceName: String, val invoice: SalesInvoiceDto)

class CreateSalesInvoiceLocalUseCase(private val repository: SalesInvoiceRepository) :
