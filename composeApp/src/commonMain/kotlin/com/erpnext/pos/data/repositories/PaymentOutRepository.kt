...
class PaymentOutRepository(private val api: APIService) {
  ...
  suspend fun fetchOutstandingPurchaseInvoicesForSupplier(
    ...
    return runCatching { api.fetchOutstandingPurchaseInvoicesForSupplier(supplier) }
        .getOrElse {
          RepoTrace.capture(
              "PaymentOutRepository",
              "fetchOutstandingPurchaseInvoicesForSupplier",
              it,
          )
          throw it
        }
