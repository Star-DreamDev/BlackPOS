...
class PosProfilePaymentMethodLocalRepository(private val dao: PosProfilePaymentMethodDao) {
  ...
  suspend fun getCashMethodsGroupedByCurrency(
    ...
    return resolved
        ...
        .mapNotNull { method ->
          val currency = method.currency?.takeIf { it.isNotBlank() }?.let { normalizeCurrency(it) }
