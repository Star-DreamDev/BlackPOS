...
data class SyncJobResult(val jobId: String, val status: SyncJobStatus, val message: String? = null)
...
class SyncOrchestrator(
  ...
  suspend fun bootstrapOpening(profileId: String): List<SyncJobResult> {
    ...
    return lock.withLock {
      ...
      results.add(
          runJob(
              "SyncPosProfilePayments",
              setOf(SyncPrerequisite.NEED_AUTH, SyncPrerequisite.NEED_PROFILE_ID),
          ) {
