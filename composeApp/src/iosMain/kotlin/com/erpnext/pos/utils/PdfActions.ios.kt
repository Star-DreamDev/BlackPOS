...
actual fun openPdfFile(path: String): Boolean {
  ...
  return runCatching { UIApplication.sharedApplication.openURL(fileUrl) }.getOrDefault(false)
}
...
actual suspend fun savePdfFileAs(path: String, suggestedFileName: String): String? {
  ...
  return suspendCancellableCoroutine { continuation ->
    ...
    continuation.invokeOnCancellation { IosPickerDelegateHolder.delegate = null }
