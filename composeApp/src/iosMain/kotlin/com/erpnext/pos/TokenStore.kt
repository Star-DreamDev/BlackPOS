...
class IosTokenStore : TokenStore, TransientAuthStore, AuthInfoStore {
  ...
  override suspend fun loadUser(): String? = defaults.stringForKey(siteScopedKey("userId"))
  ...
  override suspend fun getCurrentSite(): String? = defaults.stringForKey("current_site")
